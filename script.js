...
console.log(
  ...
  <button class="btn-aprovar" onclick="abrirAprovacaoComPrazo('${docSnap.id}')">Aprovar</button>
  <button class="btn-emespera" onclick="colocarEmEspera('${docSnap.id}')">Em espera</button>
  <button class="btn-reprovar" onclick="reprovarCompra('${docSnap.id}')">Reprovar</button>
        ` : ""}

        ${data.status === "em espera" ? `
  <button class="btn-aprovar" onclick="abrirAprovacaoComPrazo('${docSnap.id}')">Aprovar</button>
  <button class="btn-editar" onclick="editarComentarioEspera('${docSnap.id}')">Editar</button>
  <button class="btn-reprovar" onclick="reprovarCompra('${docSnap.id}')">Reprovar</button>
        ` : ""}
